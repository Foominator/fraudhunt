...
@section('content')
    <div>
        <div class="bg-red text-center pt-4 pb-4">
            ...
            <a class="btn btn-danger btn-lg align-center" href="{{route('fraud.create')}}">{{__('messages.main.button')}}</a> <br>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row pt-4 pb-4">
            ...
            <div class="col-lg-4 text-center">
                ...
                <a class="btn btn-danger btn-lg" href="{{route('fraud.index')}}">{{__('messages.main.button2')}}</a></div>
            <div class="col-lg-4 text-center">
                ...
                <a class="btn btn-danger btn-lg" href="{{route('fraud.create')}}">{{__('messages.main.button3')}}</a></div>
        </div>
    </div>
